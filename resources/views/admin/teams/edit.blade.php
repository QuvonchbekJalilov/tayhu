                                    ...
                                    <div class="tab-content p-4">
                                        ...
                                        <div class="tab-pane fade show active" id="uzConTab" role="tabpanel">
                                            <div class="form-group pb-3">
                                                ...
                                                <input type="text" class="form-control" id="position_uz" name="position_uz" value="{{ old('position_uz', $team->position_uz) }}" required>
                                            </div>
                                            <div class="form-group pb-3">
                                        ...
                                        <div class="tab-pane fade" id="enConTab" role="tabpanel">
                                            <div class="form-group pb-3">
                                                ...
                                                <input type="text" class="form-control" id="position_en" name="position_en" value="{{ old('position_en', $team->position_en) }}" required>
                                            </div>
                                            <div class="form-group pb-3">
                                        ...
                                        <div class="tab-pane fade" id="ruConTab" role="tabpanel">
                                            <div class="form-group pb-3">
                                                ...
                                                <input type="text" class="form-control" id="position_ru" name="position_ru" value="{{ old('position_ru', $team->position_ru) }}" required>
                                            </div>
                                            <div class="form-group pb-3">
                            ...
                            <div class="card stretch stretch-full">
                                ...
                                <div class="card-body custom-card-action p-0">
                                    ...
                                    <div class="form-group p-3">
                                        ...
                                        <input class="form-control" id="experience" name="experience" value="{{ old('experience', $team->experience) }}" />
                                    </div>
                                    <div class="form-group p-3">
                                        <label for="availability">Availability:</label>
                                        <input class="form-control" id="availability" name="availability" value="{{ old('availability', $team->availability) }}" />
                                    </div>
                                    <div class="form-group p-3">
                                        <label class="form-label" for="architecture">Architecture ( )%</label>
                                        <input class="form-control" type="text" name="architecture" id="architecture" value="{{ old('architecture', $team->architecture) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                    </div>
                                    <div class="form-group p-3">
                                        <label class="form-label" for="construction">Construction ( )%</label>
                                        <input class="form-control" type="text" name="construction" id="construction" value="{{ old('construction', $team->construction) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                    </div>
                                    <div class="form-group p-3">
                                        <label class="form-label" for="interior_design">Interior Design ( )%</label>
                                        <input class="form-control" type="text" name="interior_design" id="interior_design" value="{{ old('interior_design', $team->interior_design) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                                    </div>
                                </div>
                            </div>
                        </div>
