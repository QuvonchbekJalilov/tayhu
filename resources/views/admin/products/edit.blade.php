...
@section('content')
    <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate onsubmit="updateEditorContent()">
        @csrf
        @method('PUT')
                                    ...
                                    <div class="tab-content p-4">
                                        <div class="tab-pane fade show active" id="uzConTab" role="tabpanel">
                                            <div class="form-group pb-3">
                                                ...
                                                <input type="text" class="form-control" id="title_uz" name="title_uz" value="{{ old('title_uz', $product->title_uz) }}" required>
                                            </div>
                                            <div class="form-group pb-3">
                                                <label for="text_uz">Description (UZ):</label>
                                                <div id='editor_uz' style="height:200px;">{!! old('description_uz', $product->description_uz) !!}</div>
                                                <input type="hidden" id="text_uz" name="description_uz">
                                            </div>
                                            <div class="form-group pb-3">
                                                <label for="content_uz">Description (UZ):</label>
                                                <div id="editor_content_uz" style="height:200px;">{!! old('content_uz', $product->content_uz) !!}</div>
                                        ...
                                        <div class="tab-pane fade" id="enConTab" role="tabpanel">
                                            <div class="form-group pb-3">
                                                ...
                                                <input type="text" class="form-control" id="title_en" name="title_en" value="{{ old('title_en', $product->title_en) }}" required>
                                            </div>
                                            <div class="form-group pb-3">
                                                <label for="text_en">Description (EN):</label>
                                                <div id="editor_en" style="height:200px;">{!! old('description_en', $product->description_en) !!}</div>
                                                <input type="hidden" id="text_en" name="description_en">
                                            </div>
                                            <div class="form-group pb-3">
                                                <label for="content_en">Description (EN):</label>
                                                <div id="editor_content_en" style="height:200px;">{!! old('content_en', $product->content_en) !!}</div>
                                        ...
                                        <div class="tab-pane fade" id="ruConTab" role="tabpanel">
                                            <div class="form-group pb-3">
                                                ...
                                                <input type="text" class="form-control" id="title_ru" name="title_ru" value="{{ old('title_ru', $product->title_ru) }}" required>
                                            </div>
                                            <div class="form-group pb-3">
                                                <label for="text_ru">Description (RU):</label>
                                                <div id="editor_ru" style="height:200px;">{!! old('description_ru', $product->description_ru) !!}</div>
                                                <input type="hidden" id="text_ru" name="description_ru">
                                            </div>
                                            <div class="form-group pb-3">
                                                <label for="content_ru">Description (RU):</label>
                                                <div id="editor_content_ru" style="height:200px;">{!! old('content_ru', $product->content_ru) !!}</div>
                                    ...
                                    <div class="tab-content p-4">
                                        <div class="row align-items-center mb-4">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <img src="{{ asset('storage/' . $product->image) }}" alt="Product Image" style="max-width: 100%; height: auto;" class="mt-2">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row align-items-center mb-4">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                @if($product->image1)
                                                    <img src="{{ asset('storage/' . $product->image1) }}" alt="Additional Image" style="max-width: 100%; height: auto;" class="mt-2">
                                                @endif
                                            </div>
                                        </div>
                                    </div>
