                    ...
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                        <div class="dropdown-header">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="text-dark mb-0">{{ auth()->user()->first_name ?? 'user nomi qoshiladi'}} {{ auth()->user()->last_name ?? 'user nomi qoshiladi'}} <span class="badge bg-soft-success text-success ms-1">PRO</span></h6>
                                    <span class="fs-12 fw-medium text-muted">{{ auth()->user()->email ?? 'user nomi qoshiladi'}}</span>
                                </div>
                            </div>
                        </div>
                        <div class="dropdown">
...
{{--                        <div class="dropdown-menu nxl-h-dropdown">--}}
{{--                            <div class="dropdown-divider"></div>--}}
{{--                            <a href="{{ route('buildings.create') }}" class="dropdown-item">--}}
{{--                                <i class="feather-plus"></i>--}}
{{--                                <span>Building create</span>--}}
{{--                            </a>--}}
{{--                            <a href="{{ route('sections.create') }}" class="dropdown-item">--}}
{{--                                <i class="feather-plus"></i>--}}
{{--                                <span> Section create</span>--}}
{{--                            </a>--}}
{{--                            <a href="{{ route('floors.create') }}" class="dropdown-item">--}}
{{--                                <i class="feather-plus"></i>--}}
{{--                                <span>Floor creaet</span>--}}
{{--                            </a>--}}
                    ...
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                        <div class="dropdown-header">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="text-dark mb-0">{{ auth()->user()->name ?? 'user nomi qoshiladi'}}<span class="badge bg-soft-success text-success ms-1">PRO</span></h6>
                                    <span class="fs-12 fw-medium text-muted">{{ auth()->user()->email ?? 'user nomi qoshiladi'}}</span>
                                </div>
                            </div>
                        </div>
